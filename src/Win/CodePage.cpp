...
namespace hgl
{
    ...
    {
        const int src_str_size=(src_size==-1)?strlen((const char *)src):src_size;
    ...
    {
        int len; char *ansi_str; len=utf16_to(cs,&ansi_str,str.c_str(),str.Length()); return AnsiString::newOf(ansi_str,len); }
}//namespace hgl
